...
class TestSymbolRollups:
    ...
    def test_multiple_runs_same_symbol(self) -> None:
        ...
        comp2 = compute_narrative_components(
            current_rate_per_hour=10.0,
            current_acceleration=4.0,
            doc_count=10,
            platform_count=2,
            avg_sentiment=0.4,
            avg_authority=0.5,
        ...
        rollups = build_symbol_rollups([r1, r2], {"nr_1": comp1, "nr_2": comp2})
...
class TestThemeRollups:
    ...
    def test_single_theme(self) -> None:
        ...
        r2 = _make_run("nr_2", theme_id="theme_hbm", label="HBM Surge", doc_count=10)
        comps = {
...
class TestPreparePublication:
    ...
    def test_blocked_publication(self) -> None:
        runs = [_make_run()]
        result = prepare_narrative_publication(runs, _blocked_status(), now=NOW)
    ...
    def test_warn_status_still_publishes(self) -> None:
        ...
        result = prepare_narrative_publication([_make_run()], warn_health, now=NOW)
        assert result.published is True
