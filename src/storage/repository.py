...
class DocumentRepository:
    ...
    async def create_tables(self) -> None:
        """
        Backward-compatible schema helper.

        Schema ownership now lives in versioned SQL migrations. This wrapper
        remains for tests and older call sites that still expect an async hook.
        """
